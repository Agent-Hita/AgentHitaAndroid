 ...
 * skipping XMA / shared-post containers, then recursively collects text from
 * any TextView nodes that pass the caller-supplied filter.
 */
internal object InstagramConversationHelper {
    ...
    private fun collectTextViews(node: NodeInfo, out: MutableList<String>, filter: (String) -> Boolean) {
